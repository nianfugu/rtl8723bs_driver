...
ARCH := arm
CROSS_COMPILE := /data2/ngu/projects/android4sam_v4.4/prebuilts/gcc/linux-x86/arm/arm-linux-gnueabihf-4.8/bin/arm-linux-gnueabihf-
KSRC := /data2/ngu/projects/android4sam_v4.4/kernel
MODULE_NAME := wlan
endif
